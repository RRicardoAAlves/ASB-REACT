...
export default function index() {
  ...
  const navigate = useNavigate();
    ...
    const editar = async(e) => {
      ...
      await
      axios.put(`http://localhost:8080/asb/empresa/${id}`, {
      ...
      .then((result) => {
        console.log("Empresa atualizada:" + result.data)
        navigate("/home")
      }).catch((erro) => {
        console.log(erro);
    });
    ...
    <div className='contaner'>
      <div className='row'>
        <div className='col-md-6 offset-md-3 border rouded p-4 mt-2 shadow'>
          <h2 className="text center m-4">Atualizar Empresas</h2>
          ...
          <form>
            ...
            <Link to="/visualizarTodasEmpresas" type="submit" class="btn btn-outline-danger mx-2">Dados de cadastro</Link>
